...
if ($_GET['export'] == undefined) {
    url = "teacher/scripts/research-projects/manage.php?staff_id="+hidden_staff_id;
} else {
    url = "teacher/scripts/research-projects/manage.php?export=true&staff_id="+hidden_staff_id;
}

var researchProjectsTable;
var researchProjectsDatatable = function(){

    var handleResearchProjectsTable = function(){

        researchProjectsTable = $("#research-projects-table");
        ...
        //DELETE
        researchProjectsTable.on('click', '.delete', function(e) {
            $id = $(this).attr('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                $.ajax({
                    url: "http://localhost/frcrce/teacher/scripts/research-projects/delete.php",
                    method: "POST",
                    data: "delete_research_project_id=" + $id,
                    dataType: "text",
    ...
    return{
        ...
        init: function(){
            handleResearchProjectsTable();
        }
    };
}();

jQuery(document).ready(function(){
    researchProjectsDatatable.init();


    var buttons = new $.fn.dataTable.Buttons(researchProjectsTable, {
        buttons: [
            'copyHtml5',
            'excelHtml5',
            'csvHtml5',
    ...
    $('[name="research-projects-table_length"]').addClass("input-sm");
});