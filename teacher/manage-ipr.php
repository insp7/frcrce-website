...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <section class="content container-fluid">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        <div class="pull-left">
                            <a href="teacher/add-ipr.php" class="btn btn-danger">ADD <i class="fa fa-plus"></i></a>

                            <?php
                            if(isset($_GET['export'])) {
                                echo '<a href="admin/manage-ipr.php" class="btn btn-warning">EDITABLE</a>';
                            } else {
                                echo '<a href="admin/manage-ipr.php?export=true" class="btn btn-success">EXPORTABLE</a>';
                            }
                            ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table id="ipr-table" class="display nowrap"  style="width:100%">
                                <thead>
                                <tr>
                                    <th>Year</th>
    ...
    <!-- custom js -->
    <script src="assets/pages/teacher/manage-ipr.js"></script>
